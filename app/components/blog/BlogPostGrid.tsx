...
export default function BlogPostGrid({ posts, label }: Props) {
  return (
    <section className="pb-12 pt-10">
      ...
      <p className="flex items-center gap-3 text-[0.75rem] tracking-[0.25em] uppercase text-ink-warm italic mb-6 after:content-[''] after:flex-1 after:h-px after:bg-linear-to-r after:from-(--ink-decor-line) after:to-transparent">
        {label}
      </p>
